...
>
> **状态更新（2026-09-17）**：M1 已按 v3 重制并完成——实施计划与结项证据见 [`docs/superpowers/plans/2026-09-16-vase-m1-pod-loop-hotswap.md`](../plans/2026-09-16-vase-m1-pod-loop-hotswap.md)；下方「M1 计划待按 v3 口径重制」一句自此作废，本文其余部分仍按勘误块冻结。
>
